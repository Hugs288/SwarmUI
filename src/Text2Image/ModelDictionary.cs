...
public static class ModelDictionary
{
    ...
    public static void RegisterDefaults()
    {
        ...
        Register(models, new("qwen-image-edit", ModelType.ImageEdit, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["qwen-2.5-vl-7b"],  "qwen_image", "qwen-image-vae", "EmptySD3LatentImage", "ModelSamplingAuraFlow", DefaultParameters: ["sidelength:1328", "aspectratio:1:1", "cfgscale:2.5", "steps:20", "sigmashift:3.0"]));
        ...
        Register(models, new("nvidia-cosmos-1", ModelType.TextAndImageToVideo, ModelArchitecture.Dit, PredictionType.Epsilon, ["old-t5xxl"], "cosmos", "cosmos-vae", LatentNode: "EmptyCosmosLatentVideo", DefaultParameters: ["sidelength:960", "aspectratio:1:1", "cfgscale:6.5", "steps:20", "sampler:res_multistep", "scheduler:karras", "text2videoframes:121"]));
        Register(models, new("chroma", ModelType.TextToImage, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["t5xxl"], "chroma", "flux-ae", LatentNode: "EmptySD3LatentImage", "ModelSamplingSD3", DefaultParameters: ["sidelength:1024", "aspectratio:1:1", "cfgscale:3.5", "steps:26", "scheduler:beta", "sigmashift:3.0",]));
        Register(models, new("lightricks-ltx-video", ModelType.TextAndImageToVideo, ModelArchitecture.Dit, PredictionType.Epsilon, ["t5xxl"], "ltxv", "ltxv-vae", LatentNode: "EmptyLTXVLatentVideo", DefaultParameters: ["sidelength:768", "aspectratio:2:3", "cfgscale:3", "steps:30", "scheduler:ltxv", "text2videoframes:97",]));
        Register(models, new("genmo-mochi-1", ModelType.TextToVideo, ModelArchitecture.Dit, PredictionType.Epsilon, ["t5xxl"], "mochi", "mochi-vae", LatentNode: "EmptyMochiLatentVideo", DefaultParameters: ["sidelength:640", "aspectratio:16:9", "cfgscale:7", "steps:20", "text2videoframes:25"]));

        // ================= Cascade Models =================
        Register(models, new("stable-cascade-v1", ModelType.TextToImage, ModelArchitecture.Cascade, PredictionType.RectifiedFlow, [], "stable-cascade", null, LatentNode: "StableCascade_EmptyLatentImage", DefaultParameters: ["sidelength:1024", "aspectratio:1:1", "cfgscale:4", "steps:20", "sampler:euler_ancestral"]));

        // ================= MLLM Models =================
        Register(models, new("omnigen-2", ModelType.ImageEdit, ModelArchitecture.MLLM, PredictionType.RectifiedFlow, ["qwen-2.5-vl-fp16"], "omnigen2", "flux-ae", LatentNode: "EmptySD3LatentImage", DefaultParameters: ["sidelength:1024", "aspectratio:1:1", "cfgscale:7", "steps:20"]));
