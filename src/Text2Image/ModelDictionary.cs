...
public static class ModelDictionary
{
    ...
    public static void RegisterDefaults()
    {
        ...
        Register(models, new("wan-21-t2v-480p", ModelType.TextToVideo, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["umt5xxl"], "wan21-vae", 480, 480, 6, 30, "EmptyHunyuanLatentVideo", DefaultFrames: 81, DefaultSampler: "uni_pc", DefaultSigmaShift: 8, SigmaShiftNode: "ModelSamplingSD3", ClipType: "wan"));
        Register(models, new("wan-21-i2v-480p", ModelType.ImageToVideo, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["umt5xxl"], "wan21-vae", 480, 480, 6, 30, "EmptyHunyuanLatentVideo", DefaultFrames: 81, DefaultSampler: "uni_pc", DefaultSigmaShift: 8, SigmaShiftNode: "ModelSamplingSD3", ClipType: "wan"));
        Register(models, new("wan-21-t2v-720p", ModelType.TextToVideo, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["umt5xxl"], "wan21-vae", 720, 720, 6, 30, "EmptyHunyuanLatentVideo", DefaultFrames: 81, DefaultSampler: "uni_pc", DefaultSigmaShift: 8, SigmaShiftNode: "ModelSamplingSD3", ClipType: "wan"));
        Register(models, new("wan-21-i2v-720p", ModelType.ImageToVideo, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["umt5xxl"], "wan21-vae", 720, 720, 6, 30, "EmptyHunyuanLatentVideo", DefaultFrames: 81, DefaultSampler: "uni_pc", DefaultSigmaShift: 8, SigmaShiftNode: "ModelSamplingSD3", ClipType: "wan"));
