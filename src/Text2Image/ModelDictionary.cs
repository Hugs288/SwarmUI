...
public static class ModelDictionary
{
    ...
    public static void RegisterDefaults()
    {
        ...
        Register(models, new("chroma", ModelType.TextToImage, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["t5xxl"], "chroma", "flux-ae", "EmptySD3LatentImage", "ModelSamplingAuraFlow", DefaultParameters: ["sidelength:1024", "aspectratio:1:1", "cfgscale:3.5", "steps:26", "scheduler:beta", "sigmashift:3.0",]));
        Register(models, new("chroma-radiance", ModelType.TextToImage, ModelArchitecture.Dit, PredictionType.RectifiedFlow, ["t5xxl"], "chroma", "pixel_space", "EmptyChromaRadianceLatentImage", "ModelSamplingAuraFlow", DefaultParameters: ["sidelength:1024", "aspectratio:1:1", "cfgscale:3.5", "steps:30", "scheduler:beta", "sigmashift:1.0",]));
