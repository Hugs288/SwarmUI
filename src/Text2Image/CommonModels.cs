...
public static class CommonModels
{
    ...
    public static void RegisterCoreSet()
    {
        ...
        /// text encoders
        Register(new("clip-l", "CLIP-L Text Encoder (SDXL)", "The ViT-L/14 text encoder for Stable Diffusion XL.", "https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/resolve/main/text_encoder/model.fp16.safetensors", "660c6f5b1abae9dc498ac2d21e1347d2abdb0cf6c0c0c8576cd796491d9a6cdd", "Clip", "clip_l.safetensors"));
        Register(new("clip-g", "CLIP-G Text Encoder (SDXL)", "The OpenCLIP-ViT-bigG/14 text encoder for Stable Diffusion XL.", "https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/resolve/main/text_encoder_2/model.fp16.safetensors", "ec310df2af79c318e24d20511b601a591ca8cd4f1fce1d8dff822a356bcdb1f4", "Clip", "clip_g.safetensors"));
        Register(new("t5xxl", "T5-XXL Text Encoder", "The T5-v1_1-XXL encoder-only model, used by SD3, Flux, etc.", "https://huggingface.co/mcmonkey/google_t5-v1_1-xxl_encoderonly/resolve/main/t5xxl_fp8_e4m3fn.safetensors", "7d330da4816157540d6bb7838bf63a0f02f573fc48ca4d8de34bb0cbfd514f09", "Clip", "t5xxl_enconly.safetensors"));
        Register(new("old-t5xxl", "Old T5-XXL Text Encoder (Cosmos)", "The legacy T5-XXL encoder-only model, used by Nvidia Cosmos.", "https://huggingface.co/comfyanonymous/cosmos_1.0_text_encoder_and_VAE_ComfyUI/resolve/main/text_encoders/oldt5_xxl_fp8_e4m3fn_scaled.safetensors", "1d0dd711ec9866173d4b39e86db3f45e1614a4e3f84919556f854f773352ea81", "Clip", "old_t5xxl_cosmos.safetensors"));
        Register(new("umt5xxl", "UniMax T5-XXL Text Encoder (Wan)", "The UMT5-XXL encoder-only model, used by Wan 2.1 and 2.2.", "https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors", "c3355d30191f1f066b26d93fba017ae9809dce6c627dda5f6a66eaa651204f68", "Clip", "umt5_xxl_fp8_e4m3fn_scaled.safetensors"));
        Register(new("pile-t5xxl", "Pile T5-XXL", "Pile T5-XXL, used by Auraflow.", "https://huggingface.co/fal/AuraFlow-v0.2/resolve/main/text_encoder/model.safetensors", "0a07449cf1141c0ec86e653c00465f6f0d79c6e58a2c60c8bcf4203d0e4ec4f6", "Clip", "pile_t5xl_auraflow.safetensors"));
        Register(new("byt5-small-glyphxl", "ByT5-Small GlyphXL Text Encoder (Hunyuan)", "The ByT5-Small GlyphXL text encoder used by Hunyuan Image.", "https://huggingface.co/Comfy-Org/HunyuanImage_2.1_ComfyUI/resolve/main/split_files/text_encoders/byt5_small_glyphxl_fp16.safetensors", "516910bb4c9b225370290e40585d1b0e6c8cd3583690f7eec2f7fb593990fb48", "Clip", "byt5_small_glyphxl_fp16.safetensors"));
        Register(new("qwen-2.5-vl-fp16", "Qwen-2.5-VL Text Encoder (OmniGen)", "The Qwen-2.5-VL text encoder used by OmniGen.", "https://huggingface.co/Comfy-Org/Omnigen2_ComfyUI_repackaged/resolve/main/split_files/text_encoders/qwen_2.5_vl_fp16.safetensors", "ba05dd266ad6a6aa90f7b2936e4e775d801fb233540585b43933647f8bc4fbc3", "Clip", "qwen_2.5_vl_fp16.safetensors"));
        Register(new("qwen-2.5-vl-7b", "Qwen-2.5-VL-7B Text Encoder (Qwen-Image)", "The Qwen-2.5-VL-7B text encoder used by Qwen-Image.", "https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/text_encoders/qwen_2.5_vl_7b_fp8_scaled.safetensors", "cb5636d852a0ea6a9075ab1bef496c0db7aef13c02350571e388aea959c5c0b4", "Clip", "qwen_2.5_vl_7b_fp8_scaled.safetensors"));
        Register(new("clip-l-hidream", "Long CLIP-L Text Encoder (HiDream)", "The Long-CLIP-L text encoder used by HiDream-i1.", "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/clip_l_hidream.safetensors", "706fdb88e22e18177b207837c02f4b86a652abca0302821f2bfa24ac6aea4f71", "Clip", "long_clip_l_hi_dream.safetensors"));
        Register(new("clip-g-hidream", "Long CLIP-G Text Encoder (HiDream)", "The Long-CLIP-G text encoder used by HiDream-i1.", "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/clip_g_hidream.safetensors", "3771e70e36450e5199f30bad61a53faae85a2e02606974bcda0a6a573c0519d5", "Clip", "long_clip_g_hi_dream.safetensors"));
        Register(new("llava-llama3", "LLaVA-LLaMA-3 Text Encoder (Hunyuan-Video)", "The LLaVA-LLaMA-3 text encoder used by Hunyuan Video.", "https://huggingface.co/Comfy-Org/HunyuanVideo_repackaged/resolve/main/split_files/text_encoders/llava_llama3_fp8_scaled.safetensors", "2f0c3ad255c282cead3f078753af37d19099cafcfc8265bbbd511f133e7af250", "Clip", "llava_llama3_fp8_scaled.safetensors"));
        Register(new("llama3.1-8b", "LLaMA-3.1-8B Text Encoder (HiDream)", "The LLaMA-3.1-8B Instruct text encoder used by HiDream-i1.", "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/llama_3.1_8b_instruct_fp8_scaled.safetensors", "9f86897bbeb933ef4fd06297740edb8dd962c94efcd92b373a11460c33765ea6", "Clip", "llama_3.1_8b_instruct_fp8_scaled.safetensors"));
        Register(new("gemma2-2b", "Gemma-2-2B Text Encoder (Lumina)", "The Gemma-2-2B text encoder used by Lumina 2.", "https://huggingface.co/Comfy-Org/Lumina_Image_2.0_Repackaged/resolve/main/split_files/text_encoders/gemma_2_2b_fp16.safetensors", "29761442862f8d064d3f854bb6fabf4379dcff511a7f6ba9405a00bd0f7e2dbd", "Clip", "gemma_2_2b_fp16.safetensors"));
    }
}
