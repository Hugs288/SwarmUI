...
public static class CommonModels
{
    ...
    public static void RegisterCoreSet()
    {
        ...
        Register(new("ltx2-video-vae", "LTX-2 Video VAE", "https://huggingface.co/Kijai/LTXV2_comfy/resolve/main/VAE/LTX2_video_vae_bf16.safetensors", "8ea083ef4e7118c7fb5c78834fc6b76106bd31464b0c7912bb9dbc7557b0b91d", "VAE", "LTX2/LTX2_video_vae.safetensors"));
        Register(new("ltx2-audio-vae", "LTX-2 Audio VAE", "https://huggingface.co/Kijai/LTXV2_comfy/resolve/main/VAE/LTX2_audio_vae_bf16.safetensors", "f00fcace3ef1ebfa6dca9fcb4b925df47d57f826ae7df3bc8fb98f577f213204", "VAE", "LTX2/LTX2_audio_vae.safetensors"));
        ...
        Register(new("mistral_3_small_flux2", "Mistrall 3-Small", "https://huggingface.co/Comfy-Org/flux2-dev/resolve/main/split_files/text_encoders/mistral_3_small_flux2_fp4_mixed.safetensors", "1ee1ff334d78228d73049ef0ee4fcd21c1700536b5a45c06547af057f92463a7", "Clip", "mistral_3_small_flux2.safetensors"));
        ...
        Register(new("gemma3-12B-it", "Gemma 3 12B", "https://huggingface.co/Comfy-Org/ltx-2/resolve/main/split_files/text_encoders/gemma_3_12B_it_fp4_mixed.safetensors", "aaca463d11e6d8d2a4bdb0d6299214c15ef78a3f73e0ef8113d5a9d0219b3f6d", "Clip", "gemma_3_12B_it.safetensors"));
        Register(new("ltx2-embeddings-connector", "LTX2 Embeddings Connector", "https://huggingface.co/Kijai/LTXV2_comfy/resolve/main/text_encoders/ltx-2-19b-embeddings_connector_distill_bf16.safetensors", "8990ec3fe88396ca33ac1795c89b1771d88190e51e24084b21f54b25399acbed", "Clip", "ltx2/ltx2-embeddings-connector-distill.safetensors"));
        Register(new("qwen_3_06b", "Qwen-3-0.6B", "https://huggingface.co/circlestone-labs/Anima/resolve/main/split_files/text_encoders/qwen_3_06b_base.safetensors", "cd2a512003e2f9f3cd3c32a9c3573f820bb28c940f73c57b1ddaa983d9223eba", "Clip", "qwen_3_06b_base.safetensors"));
