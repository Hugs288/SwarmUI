...
function genInputs(delay_final = false) {
    ...
    let final = () => {
                    ...
                    new AdvancedPopover('initimage_res', [
                        {
                            ...
                            action: () => {
                                ...
                                for (let option of inputAspectRatio.options) {
                                    ...
                                    let ratio = parseFloat(parts[0]) / parseFloat(parts[1]);
                                    let diff = Math.abs(ratio - imageRatio);
                                    if (diff < closestDiff) {
        ...
        if (advancedVideoGroup && !currentBackendFeatureSet.includes('frameinterps') && currentBackendFeatureSet.includes('text2video')) { // this doesnt apply until refresh?
